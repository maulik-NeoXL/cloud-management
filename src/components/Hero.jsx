      ...
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        <div className="absolute flex flex-col py-8 md:min-w-[760px] bottom-[5%]
          ...
          <div className="flex justify-between flex-wrap px-4">
            <p className="flex px-4 py-2 text-slate-500"><CloudUploadIcon className="h-6 text-indigo-600" /> App
              Security</p>
            <p className="flex px-4 py-2 text-slate-500"><DatabaseIcon className="h-6 text-indigo-600" /> Dashboard
              Design</p>
